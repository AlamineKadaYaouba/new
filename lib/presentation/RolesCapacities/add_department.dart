...
class AddDepartment extends GetView<RolesCapacitiesController> {
  AddDepartment({super.key, this.role});
  Role? role;
            ...
            children: [
              SizedBox(
                ...
                child: Card(
                  ...
                  elevation: 4,
                  child: Form(
                    key: roleController.departmentForm.value,
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                            child: TextFormField(
                              controller: roleController.departmentName.value,
